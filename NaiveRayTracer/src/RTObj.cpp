...
void RTObj::init(const char * filename){
    ...
    for (int i = 0; i < n; i += 3) {
        std::vector<glm::vec3> ve = {glm::vec3(vertices[indices[i]][0], vertices[indices[i]][1], vertices[indices[i]][2]), 
        glm::vec3(vertices[indices[i+1]][0], vertices[indices[i+1]][1], vertices[indices[i+1]][2]),
        glm::vec3(vertices[indices[i+2]][0], vertices[indices[i+2]][1], vertices[indices[i+2]][2])};
