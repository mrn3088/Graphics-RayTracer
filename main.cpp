...
hittable_list two_perlin_spheres() {
    ...
    auto pertext = make_shared<noise_texture>(4); // parameter indicates higher frequency
...
int main()
{
    ...
    camera cam(lookfrom, lookat, vup, vfov, aspect_ratio, aperture, dist_to_focus, 0.0, 1.0);    // Render
    std::cout << "P3\n"
